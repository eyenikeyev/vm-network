...
<h2>Clean Up</h2>
<ul>
Open the windows command prompt, enter logoff to exit session. It is best practice to delete all of the resources in Azure Portal after finished with the lab to not accumulate a billing cost
<p>
