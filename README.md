...
<p>
Go to the Network tab and notice the Virtual Network created by the Virtual Machine by the Resource Group. It will be made automatically by the Virtual Machine
<p>
